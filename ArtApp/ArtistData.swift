...
extension ArtistData {
    static func getMockArray() -> [Artist]{
        return [
            ...
            Artist(name: "Petro", bio: "same artist", image: "4", works: [Work(title: "titya", image: "b", info: "gegemony v lesu")]),
            Artist(name: "Kyyd", bio: "japano mama", image: "3", works: [Work(title: "in garden", image: "f", info: "fifa")])
        ]
    }
}
